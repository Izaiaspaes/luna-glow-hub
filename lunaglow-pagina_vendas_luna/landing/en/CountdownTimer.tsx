          ...
          <Card className="max-w-4xl mx-auto p-8 md:p-12 border-4 border-primary shadow-2xl bg-white/95 backdrop-blur-sm">
            <div className="text-center space-y-6">
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border-2 border-green-200">
                ...
                <div className="grid md:grid-cols-3 gap-4 text-sm">
                  <div className="text-green-800">
                    ...
                    <div className="text-green-700">Save up to $69.90/year</div>
                  </div>
                  <div className="text-green-800">
                    <div className="font-bold mb-1">✓ No Price Increases</div>
                    <div className="text-green-700">Fixed price for the contracted period</div>
                  </div>
                  <div className="text-green-800">
                    <div className="font-bold mb-1">✓ Full Access</div>
                    <div className="text-green-700">All premium features included</div>
                  </div>
                </div>
              </div>
              ...
              <p className="text-sm text-muted-foreground">
                🔒 100% secure payment • 7-day guarantee
              </p>
            </div>
          </Card>
        </motion.div>
