          ...
          >
            ...
            >
              <Badge className="bg-secondary text-primary border-0 px-4 py-2 text-sm font-medium">
                ...
                Special Offer - Save on Annual Plan
              </Badge>
            </motion.div>
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-foreground/80 max-w-2xl mx-auto lg:mx-0">
                Understand your body, anticipate your phases and receive AI-powered personalized plans for each moment of your cycle
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2 text-sm">
                ...
                <div className="text-left">
                  ...
                  <div className="text-muted-foreground text-xs">Your data is safe</div>
                </div>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
