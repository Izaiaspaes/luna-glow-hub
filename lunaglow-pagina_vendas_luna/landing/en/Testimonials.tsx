...
const testimonials = [
  ...
  },
  {
    ...
    age: 32,
    photo: testimonial2,
    text: "After years suffering with PMS, Luna helped me identify patterns and anticipate symptoms. Now I know exactly what to do in each phase.",
    rating: 5,
  ...
  },
  {
    ...
    age: 25,
    photo: testimonial3,
    text: "The AI journal is incredible! It connects dots I never noticed between my cycle and my emotions. I feel much more in control.",
    rating: 5,
  ...
  },
  {
    ...
    age: 35,
    photo: testimonial4,
    text: "Luna Sense accompanies me in difficult moments. It's comforting to have someone available 24/7 who truly understands hormonal changes. I no longer feel alone.",
    rating: 5,
  ...
  },
  {
    ...
    age: 31,
    photo: testimonial6,
    text: "The personalized beauty analyses saved my skin! Adapting my skincare routine to my cycle made all the difference. I've never had such beautiful skin.",
    rating: 5,
    highlight: "Skin 100% healthier"
  }
];
        ...
        >
          <div className="inline-flex items-center gap-2 bg-secondary px-6 py-3 rounded-full">
            ...
            <span className="text-sm font-medium">
              Join <span className="text-primary font-bold">500+ women</span> who have already transformed their wellness
            </span>
          </div>
        </motion.div>
      </div>
