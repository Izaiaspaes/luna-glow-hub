      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground">
            Veja quanto dinheiro você economiza escolhendo o pacote anual
          </p>
        </motion.div>
            ...
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="p-6 rounded-xl bg-muted/50 border-2 border-border space-y-3">
                  ...
                  <div className="text-sm text-muted-foreground">
                    R$ {monthlyPrice.toFixed(2)}/mês × {months[0]} meses
                  </div>
                </div>
                ...
                <div className="p-6 rounded-xl gradient-bg text-white border-2 border-primary shadow-lg space-y-3 relative overflow-hidden">
                  ...
                  <div className="text-sm opacity-90">
                    R$ {annualMonthlyEquivalent.toFixed(2)}/mês × {months[0]} meses
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="text-xl text-green-700 font-medium">
                  Isso representa {savingsPercentage}% de economia!
                </div>
              </motion.div>
