              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border-2 border-green-200">
                ...
                <div className="grid md:grid-cols-3 gap-4 text-sm">
                  <div className="text-green-800">
                    ...
                    <div className="text-green-700">Economia de até R$ 139,80/ano</div>
                  </div>
                  <div className="text-green-800">
                    <div className="font-bold mb-1">✓ Sem Reajustes</div>
                    <div className="text-green-700">Preço fixo pelo período contratado</div>
                  </div>
                  <div className="text-green-800">
                    <div className="font-bold mb-1">✓ Acesso Completo</div>
                    <div className="text-green-700">Todos os recursos premium inclusos</div>
                  </div>
                </div>
              </div>
