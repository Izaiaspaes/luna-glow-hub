...
const features = [
  { 
    ...
    items: [
      ...
      { name: "Análisis emocional con IA", luna: true, competitor: false },
      { name: "Predicciones con Machine Learning", luna: true, competitor: true },
  ...
  },
  {
    ...
    items: [
      { name: "SOS Femenino prioritario", luna: true, competitor: false },
      { name: "Análisis de belleza por fase", luna: true, competitor: false },
      { name: "Closet Virtual inteligente", luna: true, competitor: false },
      { name: "Planes de nutrición adaptados", luna: true, competitor: false },
    ]
  },
  {
    category: "Experiencia",
    items: [
      { name: "Interfaz en español", luna: true, competitor: true },
      { name: "Soporte en español", luna: true, competitor: false },
      { name: "Sin anuncios", luna: true, competitor: false },
      { name: "Enfoque regional", luna: true, competitor: false },
    ]
  },
];

export const CompetitorComparisonES = () => {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground">
            Descubre por qué Luna Glow es la mejor opción para el bienestar femenino
          </p>
        </motion.div>
          ...
          <Card className="max-w-5xl mx-auto overflow-hidden border-2 shadow-2xl">
            <div className="grid grid-cols-3 bg-muted/50">
              ...
              <div className="p-6 text-center bg-gradient-to-br from-primary/10 to-primary/20 border-x border-border relative">
                ...
                <Badge className="mt-2 bg-primary text-white">Especializada</Badge>
              </div>
              <div className="p-6 text-center">
                ...
                <Badge className="mt-2" variant="secondary">Genérica</Badge>
              </div>
            </div>
                      ...
                      <div className="p-4 flex items-center justify-center bg-gradient-to-br from-primary/5 to-primary/10 border-x border-border">
                        {feature.luna ? (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-semibold text-primary">Sí</span>
                          </div>
                        ) : (
            ...
            <div className="bg-gradient-to-br from-primary/10 to-primary/20 p-8 text-center">
              <p className="text-lg font-semibold mb-2">
                Luna Glow tiene <span className="text-primary text-2xl">2x más funciones</span> enfocadas en el bienestar femenino
              </p>
              <p className="text-sm text-muted-foreground">
                Diseñada específicamente para las necesidades únicas de las mujeres
              </p>
            </div>
          </Card>
        </motion.div>
