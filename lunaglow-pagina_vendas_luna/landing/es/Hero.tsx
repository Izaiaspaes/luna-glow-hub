        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            >
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                Tu ciclo, tu{" "}
                <span className="gradient-text">fuerza</span>
              </h1>
              <p className="text-xl md:text-2xl text-foreground/80 max-w-2xl mx-auto lg:mx-0">
                Entiende tu cuerpo, anticipa tus fases y recibe planes personalizados por IA para cada momento de tu ciclo
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2 text-sm">
                ...
                <div className="text-left">
                  ...
                  <div className="text-muted-foreground text-xs">Tus datos seguros</div>
                </div>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                ...
                <div className="text-left">
                  <div className="font-semibold">500+ Mujeres</div>
                  <div className="text-muted-foreground text-xs">Ya transformaron</div>
                </div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              <img 
                src={heroImage} 
                alt="Mujer feliz usando Luna Glow" 
                className="w-full h-auto object-cover"
              />
            </motion.div>
            {/* Floating card */}
            <motion.div 
              className="absolute -bottom-6 -left-6 bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-border max-w-xs"
              initial={{ opacity: 0, y: 20, scale: 0.9 }}
              animate={{ opacity: 1, y: 0, scale: 1 }}
              transition={{ delay: 1, duration: 0.6, type: "spring", stiffness: 100 }}
            >
              <div className="text-sm text-muted-foreground mb-1">Último análisis</div>
              <div className="text-lg font-semibold mb-2">Tu sueño mejoró 23%</div>
