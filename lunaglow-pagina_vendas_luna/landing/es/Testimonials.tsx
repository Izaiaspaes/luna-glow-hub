...
const testimonials = [
  ...
  },
  {
    ...
    age: 35,
    photo: testimonial4,
    text: "Luna Sense me acompaña en momentos difíciles. Es reconfortante tener alguien disponible 24/7 que realmente entiende los cambios hormonales. Ya no me siento sola.",
    rating: 5,
  ...
  },
  {
    ...
    age: 31,
    photo: testimonial6,
    text: "Los análisis de belleza personalizados salvaron mi piel. Adaptar mi rutina de cuidado al ciclo hizo toda la diferencia. Nunca tuve una piel tan bonita.",
    rating: 5,
