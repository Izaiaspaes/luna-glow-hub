...
const quizQuestions = [
  {
    id: 1,
    question: "¿Cuál es tu objetivo principal con Luna Glow?",
    options: [
      "Entender mejor mi ciclo menstrual",
      "Controlar síntomas de SPM",
      "Mejorar mi bienestar general",
      "Tener apoyo emocional 24/7"
    ]
  },
  {
    id: 2,
  ...
  {
    id: 3,
    question: "¿Qué más te molesta de tu ciclo?",
    options: [
            ...
            <Card className="max-w-2xl mx-auto p-12 text-center space-y-8 border-4 border-primary shadow-2xl gradient-bg text-white">
              <div className="space-y-4">
                ...
                <p className="text-xl opacity-90">
                  Según tus respuestas, Luna Glow revolucionará la forma en que te cuidas
                </p>
              </div>
