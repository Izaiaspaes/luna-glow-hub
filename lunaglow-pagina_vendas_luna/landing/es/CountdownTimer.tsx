  ...
  return (
    <section className="py-16 bg-gradient-to-br from-primary/10 via-luna-pink-light/30 to-luna-peach/20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <Card className="max-w-4xl mx-auto p-8 md:p-12 border-4 border-primary shadow-2xl bg-white/95 backdrop-blur-sm">
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border-2 border-green-200">
                ...
                <div className="grid md:grid-cols-3 gap-4 text-sm">
                  <div className="text-green-800">
                    ...
                    <div className="text-green-700">Ahorra hasta $69.90/año</div>
                  </div>
                  <div className="text-green-800">
                    <div className="font-bold mb-1">✓ Sin Reajustes</div>
                    <div className="text-green-700">Precio fijo por el período contratado</div>
                  </div>
                  <div className="text-green-800">
                    <div className="font-bold mb-1">✓ Acceso Completo</div>
                    <div className="text-green-700">Todos los recursos premium incluidos</div>
                  </div>
                </div>
              </div>
