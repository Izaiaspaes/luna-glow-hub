...
const GuaranteeBadge = () => (
  ...
  >
    ...
    <div>
      <div className="font-bold text-lg text-green-900 dark:text-green-100">Garantía de 7 Días</div>
      <div className="text-sm text-green-700 dark:text-green-300">100% devolución de dinero</div>
    </div>
  </motion.div>
);
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div className="hidden md:block">
                  <div className="font-bold text-lg">¿Lista para transformar tu bienestar?</div>
                  <div className="text-sm text-muted-foreground">Únete a miles de mujeres que confían en Luna Glow</div>
                </div>
              </div>
              <Button size="lg" variant="cta" className="w-full md:w-auto text-lg px-8 py-6" onClick={() => window.location.href = '/onboarding'}>
                Comenzar Ahora
