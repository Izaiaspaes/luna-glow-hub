        ...
        >
          <div className="inline-flex items-center gap-3 bg-gradient-to-r from-luna-pink/20 via-luna-purple/20 to-primary/20 border border-primary/30 px-6 py-3 rounded-full shadow-md">
            <div className="flex -space-x-3">
              <img src={testimonial1} alt="Usuaria" className="w-10 h-10 rounded-full object-cover border-2 border-background" />
              <img src={testimonial2} alt="Usuaria" className="w-10 h-10 rounded-full object-cover border-2 border-background" />
              <img src={testimonial3} alt="Usuaria" className="w-10 h-10 rounded-full object-cover border-2 border-background" />
            ...
            <span className="text-sm font-medium text-foreground">
              Únete a <span className="bg-gradient-to-r from-luna-pink via-luna-purple to-primary bg-clip-text text-transparent font-bold">500+ mujeres</span> que ya transformaron su bienestar
            </span>
          </div>
        </motion.div>
      </div>
