...
export const VideoDemo = () => {
  ...
  const videoUrl = "https://www.youtube.com/embed/CEI4r-cMVjE?autoplay=1";

  const benefits = [
    "Seguimiento inteligente del ciclo",
    "IA personalizada para tu bienestar",
    "Diario con análisis emocional",
    "Soporte 24/7 con Luna Sense"
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-2">
              ...
              <span className="text-sm font-medium text-primary">Mira cómo funciona</span>
            </div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Descubre cómo Luna Glow puede revolucionar la forma en que te cuidas
            </p>
              ...
              <Card className="p-4 shadow-lg bg-card/95 backdrop-blur">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Usuarias activas</p>
                  </div>
                </div>
              </Card>
            </div>
