...
const timeline: Event[] = [
  {
    ...
    message: "Sign up for free and access your personalized dashboard in seconds.",
    icon: {
      name: "Shapes",
  ...
  },
  {
    ...
    message: "Share your wellness preferences and goals with us.",
    icon: {
      name: "Send",
  ...
  {
    label: "Get AI-Powered Insights",
    message: "Within 24h, Luna Sense starts offering personalized recommendations.",
    icon: {
      name: "Check",
  ...
  },
  {
    ...
    message: "Monitor cycle, mood, sleep, and nutrition — all in one place.",
    icon: {
      name: "Repeat",
  ...
  },
  {
    ...
    message: "Receive adaptive wellness plans and see real results.",
    icon: {
      name: "Download",
      textColor: "text-green-500",
      borderColor: "border-green-500/40",
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Start your wellness journey in just a few simple steps
          </p>
        </motion.div>
