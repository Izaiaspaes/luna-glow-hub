...
import trackingImage from "@/assets/feature-health.jpg";
import aiImage from "@/assets/feature-community.jpg";
import journalImage from "@/assets/feature-beauty.jpg";
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <Card className="group hover:shadow-xl transition-all duration-300 overflow-hidden border-2 hover:border-primary/20 bg-card h-full">
