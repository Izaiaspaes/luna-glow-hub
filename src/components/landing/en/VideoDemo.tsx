...
export const VideoDemo = () => {
  ...
  const videoUrl = "https://www.youtube.com/embed/--po6hcsGRs?autoplay=1";

  const benefits = [
    "Smart cycle tracking",
    "Personalized AI for your well-being",
    "Diary with emotional analysis",
    "24/7 support with Luna Sense"
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Discover how Luna Glow can revolutionize the way you take care of yourself
            </p>
