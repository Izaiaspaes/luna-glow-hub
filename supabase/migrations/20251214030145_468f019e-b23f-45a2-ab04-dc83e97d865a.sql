-- Drop and recreate get_users_with_profiles function to include registration_source
...
AS $$
  ...
  GROUP BY au.id, au.email, p.full_name, p.phone, p.subscription_plan, au.created_at, p.is_active, p.registration_source
